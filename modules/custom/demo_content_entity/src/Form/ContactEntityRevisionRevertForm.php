...
namespace Drupal\demo_content_entity\Form;
...
use Drupal\Core\Url;
use Drupal\demo_content_entity\Entity\ContactEntityInterface;
...
class ContactEntityRevisionRevertForm extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\demo_content_entity\Entity\ContactEntityInterface
   */
  protected $revision;
   ...
   *
   * @param \Drupal\demo_content_entity\Entity\ContactEntityInterface $revision
   *   The revision to be reverted.
   * @param \Drupal\Core\Form\FormStateInterface $form_state
   *   The current state of the form.
   *
   * @return \Drupal\demo_content_entity\Entity\ContactEntityInterface
