...
namespace Drupal\demo_content_entity\Controller;
 ...
 *
 * @package Drupal\demo_content_entity\Controller
 */
class ContactEntityController extends ControllerBase implements ContainerInjectionInterface {
   ...
   *
   * @param \Drupal\demo_content_entity\Entity\ContactEntityInterface $contact_entity
  ...
  public function revisionOverview(ContactEntityInterface $contact_entity) {
    ...
    foreach (array_reverse($vids) as $vid) {
      /** @var \Drupal\demo_content_entity\ContactEntityInterface $revision */
